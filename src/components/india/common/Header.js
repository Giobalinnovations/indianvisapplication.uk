        ...
        <div className="flex items-center justify-between h-20 px-6">
          ...
          <div className="items-center hidden space-x-8 md:flex">
            ...
            <Link href="/visa/step-one">
              <span className="inline-flex items-center px-6 py-2.5 text-sm font-medium text-white bg-purple-500 rounded-full relative overflow-hidden group hover:bg-purple-600 transition-colors duration-300">
          ...
          <nav className="divide-y divide-purple-100">
            ...
            <div className="p-4">
              <Link
                ...
                className="block w-full py-3 text-center text-white transition-colors duration-200 rounded-lg bg-purple-500 hover:bg-purple-600"
              >
                Start Application
              </Link>
            </div>

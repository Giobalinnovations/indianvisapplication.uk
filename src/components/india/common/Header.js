        ...
        <div className="flex items-center justify-between h-20 px-6">
          ...
          <div className="items-center hidden space-x-8 md:flex">
            ...
            <Link href="/visa/step-one">
              <span className="inline-flex items-center px-6 py-2.5 text-sm font-medium text-white bg-primary rounded-full hover:bg-primary-dark transition-colors duration-300">
                Start Application
                <svg
          ...
          <nav className="divide-y divide-gray-100">
            ...
            <div className="p-4">
              <Link
                ...
                className="block w-full py-3 text-center text-white transition-colors duration-200 rounded-lg bg-primary hover:bg-primary-dark"
              >
                Start Application
              </Link>
            </div>
